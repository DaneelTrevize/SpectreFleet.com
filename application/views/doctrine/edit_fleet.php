			...
			<h2>Edit Fleet Information</h2>
			
			<?php echo form_open('doctrine/edit_fleet'); ?>
				<div class="col-sm-12 ui-input <?php if(form_error('fleetName')!=NULL){echo 'has-error';}?>">
					<label>Fleet Name</label>
					<input type="text" name="fleetName" value="<?php echo set_value('fleetName', $info['fleetName'],FALSE); ?>" class="form-control">
				</div>
				...
				<div class="col-sm-12 ui-input <?php if(form_error('fleetDescription')!=NULL){echo 'has-error';}?>">
					...
					<textarea id="ckeditor" name="fleetDescription" class="form-control"><?php echo set_value('fleetDescription', $info['fleetDescription'],FALSE); ?></textarea>
				</div>
				...
				<div class="col-sm-6 col-sm-offset-3 ui-input">
					<?php
					echo form_hidden('fleetID', $info['fleetID']);
					?>
					<input type="submit" name="submit" value="Edit Fleet" class="btn btn-primary btn-block">
				</div>
			</form>
			...
			<div class="col-sm-6 col-sm-offset-3 ui-input">
				<a href="/doctrine/edit_fleets/<?php echo $info['fleetID']; ?>" class="btn btn-primary btn-block">Reset proposed changes</a><br>
			</div>
